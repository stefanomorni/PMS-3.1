...
let
    ...
    Top100Rows = Table.FirstN(table, 100), //we use up to 100 rows to establish a column type
    ColumnNameList = Table.ColumnNames(Top100Rows),
    ColumnDataLists = List.Accumulate(ColumnNameList, {}, (accumulated, i) => accumulated & {Table.Column(Top100Rows, i)}),
