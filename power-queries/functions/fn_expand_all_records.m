...
let
    Source = (TableToExpand as table, optional ColName as text, optional ColNumber as number, optional AppendOriginal as logical, optional Separator as text) =>
    let
     ...
     NewColumnNames = if AppendOriginal then List.Transform(ColumnsToExpand, each ColumnName & Separator & _) else List.Transform(ColumnsToExpand, each _),
