...
(listing_ids_list as list, fields_codes_named_range as text, max_retries as number,optional in_pull_id as nullable text, optional customer_id as nullable text, optional timeout_seconds as nullable number) =>
let    
    ...
    corrected_listing_ids = List.Select(List.Transform(validated_listing_ids, lukb_validate_listing_id), each _ <> null),
    ...
    data = lukb_get_json_data(corrected_listing_ids,corrected_fields_types,max_retries,null, in_pull_id,customer_id,timeout_seconds,null),
