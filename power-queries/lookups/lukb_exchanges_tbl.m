...
let
    ...
    #"Renamed Columns" = Table.RenameColumns(LUKB_Markets_Table,{{"value", "exch_code"}, {"description", "exch_des"}, {"id", "exch_id"}}),
    #"Changed Type" = Table.TransformColumnTypes(#"Renamed Columns",{{"exch_id", type text}, {"exch_des", type text}, {"exch_code", type text}})
in
    #"Changed Type"
